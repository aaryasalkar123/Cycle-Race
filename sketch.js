...
function setup(){
  ...
  //seting collider for mainCyclist
   mainCyclist.setCollider("rectangle",0,0,0.5,0.5);

  //crating the gameOver sprite
...
//incresing the score
  ...
  if(redCG.isTouching(mainCyclist)){
    ...
    // changing the animation of the mainCyclist
mainCyclist.addAnimation("SahilRunning",mainRacerImg2);
    //stoping the opponents
